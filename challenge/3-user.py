...
if __name__ == '__main__':
    ...
    if user_1.id is None:
        ...
        print("User 1 ID assigned correctly.")
    ...
    if user_2.password is not None:
        ...
        print("User 2 password is None by default.")

    user_2.password = None
    if user_2.password is not None:
        print("User.password should be None if setter to None")
    else:
        print("Password set to None works correctly.")

    user_2.password = 89
    if user_2.password is not None:
        print("User.password should be None if setter to an integer")
    else:
        print("Password set to integer is handled correctly.")
